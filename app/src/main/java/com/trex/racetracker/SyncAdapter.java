...
public class SyncAdapter extends AbstractThreadedSyncAdapter {
   ...
   // protected static final String TYPE_SYNC_PULL = "sync_pull";
    protected static final String URL_SYNC_PUSH = "https://chupino.trex.mk/syncEntries_push.php";
   // protected static final String URL_SYNC_PULL = "https://chupino.trex.mk/syncEntries_pull.php";
