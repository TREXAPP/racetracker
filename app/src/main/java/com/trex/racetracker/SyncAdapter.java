...
public class SyncAdapter extends AbstractThreadedSyncAdapter {
   ...
   // protected static final String TYPE_SYNC_PULL = "sync_pull";
    protected static final String URL_SYNC_PUSH = "https://results.germiaultratrail.com/syncEntries_push.php";
   // protected static final String URL_SYNC_PULL = "https://results.germiaultratrail.com/syncEntries_pull.php";
