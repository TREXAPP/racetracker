...
public class Login extends Fragment {
    ...
    protected static final String URL_LOGIN = "https://results.germiaultratrail.com/login.php";
    protected static final String URL_LOGOUT = "https://results.germiaultratrail.com/logout.php";
